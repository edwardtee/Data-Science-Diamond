...
# Friendly names for known model abbreviations
FRIENDLY_NAMES = {
    "etr": "Extra Tree Regression",
    "svr": "Support Vector Regression",
    "lr": "Linear Regression",
    "gbr": "Gradient Boosting Regression (Pro)",
}

# Build a friendly display name -> path mapping, e.g. "Extra Tree Regression" -> etr_model.joblib
MODEL_OPTIONS = {
